  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/4 h-80 w-80 rounded-full bg-violet-500/8 blur-3xl" />
        <div className="absolute bottom-1/4 -right-20 h-80 w-80 rounded-full bg-cyan-500/8 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-slate-400">Start monitoring worker safety with HELMSECURE</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link to="/login" className="font-medium text-sky-400 transition hover:text-sky-300">Sign in</Link>
        </p>
      </div>
    </div>
  );
